      ...
      <div className="bg-white border border-gray-100 rounded-[2px] shadow-sm p-5">
        ...
        <div className="mt-6 pt-4 border-t border-gray-100">
          ...
          <div className="mt-4 flex gap-2">
            <button onClick={() => window.print()} className="flex-1 py-2 rounded-[2px] text-sm font-medium border border-gray-100 bg-white hover:bg-gray-50">Print</button>
            <a href="mailto:support@bookstore.com" className="py-2 px-3 rounded-[2px] text-sm font-medium border border-gray-100 bg-white hover:bg-gray-50">Contact</a>
          </div>
        </div>
      </div>
    </aside>
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <header className="text-center mb-10">
          ...
          <p className="mt-3 text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
            Please read these terms before using our Book Store. We keep language clear and approachable.
          </p>
        </header>
          ...
          <main className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white border border-gray-100 rounded-[2px] p-6 shadow-sm">
              ...
              <p className="mt-2 text-base text-slate-700">
                Using our Book Store means you accept these Terms &amp; Conditions. If you need legal certainty, consult a lawyer.
              </p>
            </div>

            <Collapsible title="1. Introduction" icon="book" defaultOpen>
              <p>
                By accessing and using our Book Store you agree to these terms. They protect our community and keep service quality high.
              </p>
            </Collapsible>
            ...
            <Collapsible title="3. Purchases &amp; Payments" icon="payment">
              <p>
                All purchases are processed via secure payment gateways. Prices shown at checkout are final and receipts are emailed.
              </p>
            </Collapsible>

            <Collapsible title="4. Refund &amp; Return Policy" icon="clock">
              <p>
                Refunds available for defective or incorrect physical items reported within 7 days. Digital products are non-refundable once delivered.
              </p>
            </Collapsible>

            <Collapsible title="5. Changes to Terms" icon="book">
              <p>
                We may update these Terms occasionally. We'll publish the updated date. Continued use after changes means you accept them.
              </p>
            </Collapsible>
            ...
            <Collapsible title="6. Contact &amp; Disputes" icon="mail">
              <p>
                Questions? Email{" "}
                <a href="mailto:support@bookstore.com" className="text-amber-600 underline">
                  support@bookstore.com
                </a>. We aim to resolve issues quickly.
              </p>
            </Collapsible>

            <div className="text-sm text-gray-500">
              Note: This template is for general guidance and doesn't replace legal advice.
            </div>
          </main>
        ...
        <footer className="mt-10 text-center">
          <div className="inline-block bg-white border border-gray-100 p-4 rounded-[2px] shadow-sm">
            <div className="text-sm text-slate-900">
              Thank you for being part of our <span className="font-semibold">Book Store</span>.
            </div>
          </div>
        </footer>
      </div>
