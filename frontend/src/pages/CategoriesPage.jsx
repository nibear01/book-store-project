...
/**
 * Fixed Bookstore Categories Page - All syntax errors resolved
 * 
 * What: Fixed version of the bookstore categories page with proper JSX syntax
 * Why: Original code had critical syntax errors causing blank page
 * Fixes: Corrected all JSX syntax, fixed image paths, implemented proper swipe handling
 * Note: All critical errors that caused blank page are fixed below
 */
const CategoriesPage = () => {
  // Sample book data with VALID image URLs (using Unsplash)
  const sampleBooks = [
    {
      id: 1,
      title: "The Great Gatsby",
      author: "F. Scott Fitzgerald",
      description: "A novel set in the 1920s, exploring themes of wealth, society, and the American Dream.",
      genre: "Fiction",
      language: "English",
      isbn: "9780743273565",
    ...
    },
    {
      ...
      language: "English",
      isbn: "9780441172719",
      cover_image: "https://images.unsplash.com/photo-1446776877081-d282a0f896e2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      price: 15.99,
      stock: 45,
    ...
    },
    {
      ...
      language: "English",
      isbn: "9780141439514",
      cover_image: "https://images.unsplash.com/photo-1535905557550-315a2d2c3c3d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      price: 9.99,
      stock: 30,
    ...
    },
    {
      ...
      description: "A fantasy novel about the journey of Bilbo Baggins and his adventure with a wizard and thirteen dwarves.",
      genre: "Fantasy",
      language: "English",
      isbn: "9780547928227",
      cover_image: "https://images.unsplash.com/photo-1532012197267-da84c2bb1e70?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      price: 14.50,
      stock: 20,
    ...
    },
    {
      ...
      language: "English",
      isbn: "9781250301697",
      cover_image: "https://images.unsplash.com/photo-1553729459-efe14ef6055d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      price: 11.25,
      stock: 15,
    ...
    },
    {
      ...
      author: "Harper Lee",
      description: "A novel about the serious issues of rape and racial inequality through the eyes of a young girl.",
      genre: "Classic",
      language: "English",
      isbn: "9780061120084",
      cover_image: "https://images.unsplash.com/photo-1535905557550-315a2d2c3c3d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  // Category data with VALID image URLs (using Unsplash)
  const categories = [
    { 
      id: 1, 
      title: "Fiction", 
      item: `${sampleBooks.filter(b => b.genre === "Fiction").length} books`, 
      img: "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
    },
    { 
      id: 2, 
      title: "Science Fiction", 
      item: `${sampleBooks.filter(b => b.genre === "Science Fiction").length} books`, 
      img: "https://images.unsplash.com/photo-1446776877081-d282a0f896e2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
    },
    { 
      id: 3, 
      title: "Romance", 
      item: `${sampleBooks.filter(b => b.genre === "Romance").length} books`, 
      img: "https://images.unsplash.com/photo-1535905557550-315a2d2c3c3d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
    },
    { 
      id: 4, 
      title: "Fantasy", 
      item: `${sampleBooks.filter(b => b.genre === "Fantasy").length} books`, 
      img: "https://images.unsplash.com/photo-1532012197267-da84c2bb1e70?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
    },
    { 
      id: 5, 
      title: "Classic", 
      item: `${sampleBooks.filter(b => b.genre === "Classic").length} books`, 
      img: "https://images.unsplash.com/photo-1553729459-efe14ef6055d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
    },
    { 
      id: 6, 
      title: "Mystery", 
      item: `${sampleBooks.filter(b => b.genre === "Mystery").length} books`, 
      img: "https://images.unsplash.com/photo-1553729459-efe14ef6055d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
    }
  ];
  ...
  const renderStars = (rating) => {
    ...
    if (hasHalfStar) {
      stars.push(
        <svg key="half" className="h-4 w-4 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <defs>
          ...
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.539 1.118l-3.976-2.888a1 1 0 00-1.175 0l-3.976 2.888c-.784.57-1.838-.197-1.539-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.783-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" fill="url(#halfStarGradient)" />
        </svg>
      );
    }
  ...
  useEffect(() => {
    ...
    switch(sortOption) {
      ...
      default: // featured/bestselling
        result.sort((a, b) => b.is_featured - a.is_featured || b.num_reviews - a.num_reviews);
    }

    setFilteredBooks(result);
  }, [selectedCategory, sortOption, priceRange, ratingFilter, 
      languageFilter, availabilityFilter, searchQuery]);
  ...
  const FilterSection = ({ title, children, sectionId }) => (
    <div className="mb-6 border-b border-gray-200 pb-6 last:border-b-0 last:pb-0">
      ...
      >
        ...
        <svg 
          className={`h-5 w-5 transform transition-transform ${filterSections[sectionId] ? 'rotate-180' : ''}`} 
          viewBox="0 0 20 20" 
          fill="currentColor"
        >
      ...
      <div 
        ...
        className={`mt-3 overflow-hidden transition-all duration-300 ${
          filterSections[sectionId] ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'
        }`}
      >
        {children}
      </div>
  ...
  const CategoryCard = ({ id, title, item, img, isSelected, onClick }) => (
    ...
    >
      <div className="relative overflow-hidden rounded-xl h-[200px] mb-3">
        <img 
          src={img} 
          alt={`${title} category`} 
      ...
      <div 
        className={`${isSelected ? 'w-full' : 'w-0'} h-1.5 absolute bottom-0 left-0 group-hover:w-full transition-all duration-300 bg-gradient-to-r from-green-500 to-teal-400`}
      />
    </div>
  );
  ...
  const BookCard = ({ book }) => (
    <div className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-lg transition-shadow duration-300 border border-gray-100">
      {/* Book cover image */}
      ...
      <div className="p-4">
        <div className="flex flex-col h-full">
          {/* Genre tag */}
          <span className="inline-block px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full w-fit mb-2">
            {book.genre}
          </span>
          ...
          <div className="flex items-center justify-between mb-4">
            <p className="text-green-700 font-bold text-lg">${book.price.toFixed(2)}</p>
          ...
          {/* Add to cart button */}
          <button 
            className="w-full bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white py-2.5 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md"
  ...
  const ViewToggle = ({ currentView, onViewChange }) => (
    <div className="flex bg-gray-100 rounded-lg p-1">
      <button
        ...
        className={`flex-1 py-1.5 rounded-l-md text-sm font-medium transition-colors ${
          currentView === "grid" 
      ...
      <button
        ...
        className={`flex-1 py-1.5 rounded-r-md text-sm font-medium transition-colors ${
          currentView === "list" 
            ? "bg-white shadow-sm text-gray-900" 
            : "text-gray-600 hover:text-gray-900"
        }`}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-green-600 to-teal-600 text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Discover Your Next Favorite Book</h1>
          <p className="text-xl max-w-3xl mx-auto">Explore our collection of carefully curated books across all genres</p>
        </div>
      </div>
                    ...
                    {ratingFilter > 0 && (
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                        ...
                        <button
                          ...
                          className="ml-1.5 rounded-full p-0.5 hover:bg-yellow-200"
                    ...
                    {languageFilter !== "All" && (
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                        ...
                        <button
                          ...
                          className="ml-1.5 rounded-full p-0.5 hover:bg-purple-200"
                    ...
                    {availabilityFilter !== "all" && (
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
                        ...
                        <button
                          ...
                          className="ml-1.5 rounded-full p-0.5 hover:bg-indigo-200"
                          aria-label={`Remove ${availabilityFilter === "inStock" ? "In Stock" : "Out of Stock"} filter`}
                        >
                          ×
                        </button>
                      </span>
                    ...
                    {priceRange[0] > 0 && (
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                        ...
                        <button
                          ...
                          className="ml-1.5 rounded-full p-0.5 hover:bg-orange-200"
                    ...
                    {searchQuery && (
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                        ...
                        <button
                          ...
                          className="ml-1.5 rounded-full p-0.5 hover:bg-gray-200"
                  ...
                  {categories.map(category => (
                    <div 
                      ...
                      className={`flex items-center p-2 rounded-md cursor-pointer transition-colors ${
                        selectedCategory === category.title ? 'bg-green-50 text-green-700 font-medium' : 'hover:bg-gray-50'
                      }`}
              ...
              <FilterSection title="Price Range" sectionId="price">
                <div className="px-2">
                  ...
                  <input
                    ...
                    className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-green-500 mt-4"
            ...
            <div className="mt-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                  ...
                  <div className="relative w-full sm:w-auto">
                    <select
                      ...
                      className="pl-3 pr-8 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 appearance-none bg-white w-full sm:w-auto"
              ...
              <div className="mt-4">
                {filteredBooks.length === 0 ? (
                  ...
                  mobileViewStrategy === "carousel" ? (
                    // Mobile Swipe Pager
                    <div className="h-[calc(100vh-200px)]" style={{ minHeight: '400px' }}>
                      <MobileCardPager>
                        {Array.from({ length: calculateGroupCount() }).map((_, groupIndex) => {
                          const groupBooks = filteredBooks.slice(groupIndex * 4, groupIndex * 4 + 4);
                          ...
                          return (
                            <div 
                              ...
                              style={{ 
                                paddingLeft: groupIndex === 0 ? 'env(safe-area-inset-left, 1rem)' : '1rem',
                                paddingRight: groupIndex === calculateGroupCount() - 1 ? 'env(safe-area-inset-right, 1rem)' : '1rem'
                              }}
                            >
