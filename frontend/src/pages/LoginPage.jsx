          ...
          <form onSubmit={handleLogin} className="flex-col justify-center">
            <div className="space-y-3 mb-3">
              ...
              <input
                ...
                !focus:border-grey-500 outline-none transition-all duration-200 text-sm"
                required
              />
            </div>
            <div className="space-y-1 relative">
              ...
              <div className="relative">
                <input
                  ...
                  value={password}
                  placeholder="••••••••"
                  className="w-full p-3 border border-gray-300 focus:ring-2 focus:ring-grey-500 focus:border-grey-500 outline-none transition-all duration-200 pr-10"
                  required
                />
                <button
                  type="button"
